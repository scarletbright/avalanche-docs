...
Suppose we want all UTXOs that reference at least one of `X-xMrKg8uUECt5CS9RE9j5hizv2t2SWTbk` and `X-DjU3SbP9ZfPW8YAvFdjivR4Hjfxu2VCLu`.
...
curl -X POST --data '{
    ...
    "method" :"avm.getUTXOs",
    "params" :{
        "addresses":["X-xMrKg8uUECt5CS9RE9j5hizv2t2SWTbk", "X-DjU3SbP9ZfPW8YAvFdjivR4Hjfxu2VCLu"],
        "limit":5
    }
}' -H 'content-type:application/json;' 127.0.0.1:9650/ext/bc/X
```
...
```json
{
    ...
    "result": {
        ...
        "endIndex": {
            "address": "X-DjU3SbP9ZfPW8YAvFdjivR4Hjfxu2VCLu",
...
curl -X POST --data '{
    ...
    "method" :"avm.getUTXOs",
    "params" :{
        "addresses":["X-DjU3SbP9ZfPW8YAvFdjivR4Hjfxu2VCLu"],
        "limit":5,
        "endIndex": {
            "address": "X-DjU3SbP9ZfPW8YAvFdjivR4Hjfxu2VCLu",
            "utxo": "kbUThAUfmBXUmRgTpgD6r3nLj7rJUGho6xyht5nouNNypH45j"
