...
An unsigned base tx contains an `ID`, `NetworkID`, `BlockchainID`, `Outputs`, and `Inputs`.

- **`ID`** is an int that defines which transaction type this is. Is `0x00000000`.
...
+---------------+----------------------+-----------------------------------------+
                                       | 48 + size(outputs) + size(inputs) bytes |
                                       +-----------------------------------------+
```
...
```splus
[
    BaseTx        <- 
...
```splus
[
    BaseTx        <- 
    Ops <- [
...
### Unsigned Import Tx Identifier

The transaction identifier for an import tx is `0x00000003`.

### What Unsigned Import Tx Contains

An unsigned import tx contains a BaseTx, and Ins.

* `ID` is defined in BaseTx. For an import tx, the ID is `0x00000003`.
...
* `BaseTx`: "Example BaseTx as defined above with ID set to 3"
* `Ins`: "Example SECP256K1 Transfer Input as defined above"

```splus
[
    BaseTx        <- 
    Ins <- [
...
- **`UnsignedTx`**: ``
- **`Credentials`**
