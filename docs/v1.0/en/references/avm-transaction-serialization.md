...
An SECP256K1 Mint output contains a `TypeID`, `Locktime`, `Threshold`, and `Addresses`.
...
An SECP256K1 Mint operation contains a `TypeID`, `AddressIndices`, `MintOutput`, and `TransferOutput`.
...
[
    TypeID <- 0x00000008
    AddressIndices <- [0x00000007, 0x00000003]
    MintOutput <- 0x000000000000d431000000010000000251025c61fbcfc078f69334f834be6dd26d55a955c3344128e060128ede3523a24a461c89
...
Unsigned transactions contain the full content of a transaction with only the signatures missing. Unsigned transactions have four possible types: `CreateAssetTx`, `OperationTx`, `ImportTx`, and `ExportTx`.
They all embed `BaseTx`, which contains common fields and operations.
