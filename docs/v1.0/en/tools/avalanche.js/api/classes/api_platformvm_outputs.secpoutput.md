[avalanche](../README.md) › [API-PlatformVM-Outputs](../modules/api_platformvm_outputs.md) › [SecpOutput](api_platformvm_outputs.secpoutput.md)
...
* [constructor](api_platformvm_outputs.secpoutput.md#constructor)

### Properties

* [addresses](api_platformvm_outputs.secpoutput.md#protected-addresses)
* [amount](api_platformvm_outputs.secpoutput.md#protected-amount)
* [amountValue](api_platformvm_outputs.secpoutput.md#protected-amountvalue)
* [locktime](api_platformvm_outputs.secpoutput.md#protected-locktime)
* [numaddrs](api_platformvm_outputs.secpoutput.md#protected-numaddrs)
* [threshold](api_platformvm_outputs.secpoutput.md#protected-threshold)

### Methods

* [fromBuffer](api_platformvm_outputs.secpoutput.md#frombuffer)
* [getAddress](api_platformvm_outputs.secpoutput.md#getaddress)
* [getAddressIdx](api_platformvm_outputs.secpoutput.md#getaddressidx)
* [getAddresses](api_platformvm_outputs.secpoutput.md#getaddresses)
* [getAmount](api_platformvm_outputs.secpoutput.md#getamount)
* [getLocktime](api_platformvm_outputs.secpoutput.md#getlocktime)
* [getOutputID](api_platformvm_outputs.secpoutput.md#getoutputid)
* [getSpenders](api_platformvm_outputs.secpoutput.md#getspenders)
* [getThreshold](api_platformvm_outputs.secpoutput.md#getthreshold)
* [makeTransferable](api_platformvm_outputs.secpoutput.md#maketransferable)
* [meetsThreshold](api_platformvm_outputs.secpoutput.md#meetsthreshold)
* [toBuffer](api_platformvm_outputs.secpoutput.md#tobuffer)
* [toString](api_platformvm_outputs.secpoutput.md#tostring)
* [comparator](api_platformvm_outputs.secpoutput.md#static-comparator)

## Constructors

###  constructor

\+ **new SecpOutput**(`amount`: BN, `addresses`: Array‹Buffer›, `locktime`: BN, `threshold`: number): *[SecpOutput](api_platformvm_outputs.secpoutput.md)*
...
**Returns:** *[SecpOutput](api_platformvm_outputs.secpoutput.md)*
...
Defined in src/apis/platformvm/outputs.ts:55
