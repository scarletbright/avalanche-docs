[avalanche](../README.md) › [Common-Payload](../modules/common_payload.md) › [NFTIDPayload](common_payload.nftidpayload.md)
...
* [constructor](common_payload.nftidpayload.md#constructor)

### Properties

* [payload](common_payload.nftidpayload.md#protected-payload)
* [typeid](common_payload.nftidpayload.md#protected-typeid)

### Methods

* [fromBuffer](common_payload.nftidpayload.md#frombuffer)
* [getContent](common_payload.nftidpayload.md#getcontent)
* [getPayload](common_payload.nftidpayload.md#getpayload)
* [returnType](common_payload.nftidpayload.md#returntype)
* [toBuffer](common_payload.nftidpayload.md#tobuffer)
* [typeID](common_payload.nftidpayload.md#typeid)
* [typeName](common_payload.nftidpayload.md#typename)

## Constructors

###  constructor

\+ **new NFTIDPayload**(`payload`: any): *[NFTIDPayload](common_payload.nftidpayload.md)*
...
**Returns:** *[NFTIDPayload](common_payload.nftidpayload.md)*
...
*Overrides [UTXOIDPayload](common_payload.utxoidpayload.md).[typeid](common_payload.utxoidpayload.md#protected-typeid)*

Defined in src/utils/payload.ts:505
