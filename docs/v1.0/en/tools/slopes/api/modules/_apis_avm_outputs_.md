[slopes - v1.7.5](../README.md) › ["apis/avm/outputs"](_apis_avm_outputs_.md)
...
*Defined in [apis/avm/outputs.ts:9](https://github.com/ava-labs/slopes/blob/be20cee/src/apis/avm/outputs.ts#L9)*
...
*Defined in [apis/avm/outputs.ts:18](https://github.com/ava-labs/slopes/blob/be20cee/src/apis/avm/outputs.ts#L18)*
