[slopes - v1.7.5](../README.md) › ["apis/avm/inputs"](_apis_avm_inputs_.md)
...
*Defined in [apis/avm/inputs.ts:21](https://github.com/ava-labs/slopes/blob/db73b16/src/apis/avm/inputs.ts#L21)*
