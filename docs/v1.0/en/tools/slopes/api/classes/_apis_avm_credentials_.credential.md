[slopes - v1.7.1](../README.md) › ["apis/avm/credentials"](../modules/_apis_avm_credentials_.md) › [Credential](_apis_avm_credentials_.credential.md)
...
*Defined in [apis/avm/credentials.ts:37](https://github.com/ava-labs/slopes/blob/0d1acbd/src/apis/avm/credentials.ts#L37)*
