[slopes - v1.7.5](../README.md) › ["utils/types"](../modules/_utils_types_.md) › [APIBase](_utils_types_.apibase.md)
...
*Defined in [utils/types.ts:66](https://github.com/ava-labs/slopes/blob/be20cee/src/utils/types.ts#L66)*
