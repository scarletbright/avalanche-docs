[slopes - v1.7.3](../README.md) › ["utils/types"](../modules/_utils_types_.md) › [NBytes](_utils_types_.nbytes.md)
...
*Defined in [utils/types.ts:466](https://github.com/ava-labs/slopes/blob/51a37ef/src/utils/types.ts#L466)*
